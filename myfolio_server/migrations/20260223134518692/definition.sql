...
--
-- Class Education as table educations
--
...
--
-- Class Experience as table experiences
--
...
--
-- Class SoftSkill as table soft_skills
--
...
--
-- Class WorkSkill as table work_skills
--
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('myfolio', '20260223134518692', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260223134518692', "timestamp" = now();
