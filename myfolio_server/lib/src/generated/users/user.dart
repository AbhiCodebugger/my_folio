...
class UserUpdateTable extends _i1.UpdateTable<UserTable> {
  ...
  _i1.ColumnValue<List<String>, List<String>> socialUrls(List<String> value) =>
      _i1.ColumnValue(
        table.socialUrls,
        value,
      );
...
class UserTable extends _i1.Table<int?> {
  UserTable({super.tableRelation}) : super(tableName: 'user') {
    ...
    socialUrls = _i1.ColumnSerializable<List<String>>(
      'socialUrls',
      this,
    );
  ...
  late final _i1.ColumnSerializable<List<String>> socialUrls;
