...
import 'package:myfolio_server/src/generated/protocol.dart' as _i2;
...
class ProjectUpdateTable extends _i1.UpdateTable<ProjectTable> {
  ...
  _i1.ColumnValue<String, String> projectUrl(String? value) => _i1.ColumnValue(
    table.projectUrl,
    value,
  );

  _i1.ColumnValue<List<String>, List<String>> techStack(List<String>? value) =>
      _i1.ColumnValue(
        table.techStack,
        value,
      );
...
class ProjectTable extends _i1.Table<int?> {
  ProjectTable({super.tableRelation}) : super(tableName: 'projects') {
    ...
    projectUrl = _i1.ColumnString(
      'projectUrl',
      this,
    );
    techStack = _i1.ColumnSerializable<List<String>>(
      'techStack',
      this,
    );
  ...
  late final _i1.ColumnString projectUrl;

  late final _i1.ColumnSerializable<List<String>> techStack;
